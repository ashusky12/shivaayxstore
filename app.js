      ...
      <div class="detail-layout">
        ...
        <div>
          ...
          <section style="margin-top: 2rem;">
            <h2 style="font-size: 1.25rem;">Overview Description</h2>
          ...
          <section style="margin-top: 2.5rem;">
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1rem;">
              ...
              <div>
                <h2 style="font-size: 1.125rem;">Collection Walkthrough</h2>
          ...
          <section style="margin-top: 2.5rem;">
            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1rem;">
              ...
              <div>
                <h2 style="font-size: 1.125rem;">Account Specifications</h2>
...
function renderHowItWorks() {
  appRoot.innerHTML = `
    <div class="shell section-py" style="padding-top: 2rem;">
      ...
      <ol class="process-list" style="display: flex; flex-direction: column; gap: 1rem; max-width: 768px; margin-inline: auto;">
      ...
      <section class="glass" style="max-width: 768px; margin-inline: auto; margin-top: 3.5rem; padding: 2rem;">
